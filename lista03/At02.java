package lista_exercicios.lista03;
...
public class At02 { 
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < numeral.length; i++) {
            System.out.print("Olá " + name + " Informe o número " + (i + 1));
        ...
        System.out.println("Obrigado " + name +" Por responder ! ate breve");
