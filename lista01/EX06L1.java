...
public class EX06L1 {
    public static void main(String[] args) {
        ...
        if (valor02 == 1 ) {
            ...
            System.out.println(" Opção 3 Parcelamento em até 12x - Informe a quantidade de parcelas ! ");
            parc = input.nextInt();
            resposta = valor01 + (valor01 * 0.1f * parc );
            System.out.println(
                " Valor R$ " + valor01 + " Dividiu " + parc + " Parcelas, Com arcrescimo : Total de R$ " + resposta );
